...
EMILY_TAXONOMY = {
    ...
    "P4_Q6": {
        ...
        "options": [
            ...
            "Yes, only for theoretical classes",
            "No",
    ...
    "P4_Q8": {
        ...
        "options": [
            ...
            "No",
            "No, personality traits vary in each student",
            "No, subjective posture from professors",
            "No, variable emotions throughout the day",
        ],
    },
}
